...
Na means that some of the values are missing and since the calculations cant work unless all values are in the same numerical data type calculation isnt working
...
**Write your answer here**
na.rm excludes the Na data from the result
...
There are a greater number of lower values in comparrison to higher values and the higher values are significantly larger
